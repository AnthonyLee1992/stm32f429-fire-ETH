...
/** if you want to use on chip flash you can use the following instructions.
 *
 * STEP 1 define macro related to the on chip CAN
 *                 such as    BSP_USING_CAN
 *
 * STEP 2, modify your stm32xxxx_hal_config.h file to support on CAN peripherals. define macro related to the peripherals
 *                 such as     #define HAL_CAN_MODULE_ENABLED
 *
 */
